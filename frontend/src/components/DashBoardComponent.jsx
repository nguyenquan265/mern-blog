  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        if (res.ok) {
          setUsers(data.users)
          setTotalUsers(data.totalUsers !== 0 ? data.totalUsers : 0)
    ...
    const fetchComments = async () => {
      try {
        ...
        if (res.ok) {
          ...
          settotalComments(data.totalComments !== 0 ? data.totalComments : 0)
    ...
    const fetchPosts = async () => {
      try {
        ...
        if (res.ok) {
          setPosts(data.posts)
          setTotalPosts(data.totalPosts !== 0 ? data.totalPosts : 0)
